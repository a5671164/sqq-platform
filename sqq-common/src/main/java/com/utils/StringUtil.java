...
public class StringUtil {
	...
	public static String getPrimarykey() {
		...
		if (org.apache.commons.lang3.StringUtils.isNotEmpty(primarykey) && primarykey.length() > 30) {
...
//		String a = "abc1234gfgdfgdf";
//		// 客户编码
//		System.out.println(sub(a, 0, 3));
//		//类型
//		System.out.println(sub(a, 3, 4));
//		//值
//		System.out.println(sub(a, 4, 7));
//		
//		
//		System.out.println(Integer.valueOf("023"));
		System.out.println(checkEmail("13246789@qq.com"));
	}
